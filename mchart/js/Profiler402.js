...
//                      {row:2,min_y:3.4,max_y:3.62,float:2,title:"燃料气流量",nowvalue:null,ucl:3.57,lcl:3.45,mid:3.51}
                        {row:1,min_y:100,max_y:1100,float:1,title:"乙烯产品中乙烷浓度",nowvalue:null,ucl:900,lcl:495,mid:700,spvalue:null},//row:行数,min_y:Y轴最小值,max_y:Y轴最大值,float:数据保留小数位数,title:行标题
                        {row:2,min_y:100,max_y:6000,float:1,title:"循环乙烷中乙烯浓度",nowvalue:null,ucl:4000,lcl:1500,mid:2550,spvalue:null},
                        {row:3,min_y:1500,max_y:3000,float:1,title:"能耗(千克标油)",nowvalue:null,ucl:2750,lcl:1750,mid:2250,spvalue:null}
                ],//数据行
            cells:
                [
                    {cell:1,min_x:55000,max_x:85000,float:0,title:"进料流量(kg/h)",nowvalue:null,dir:"down",xitems:[],gno:"FIC2409"},
                    {cell:2,min_x:210000,max_x:355000,float:0,title:"乙烯精馏塔回流量(kg/h)",nowvalue:null,dir:"up",xitems:[],gno:"FIC2414"},//cell:列,min_x:X轴最小值,max_x:X轴最大值,float:数据保留小数位数,title:行标题
                    {cell:3,min_x:75000,max_x:115000,float:0,title:"塔釜丙烯冷剂流量(kg/h)",nowvalue:null,dir:"up",xitems:[],gno:"FIC2503"}//cell:列,min_x:X轴最小值,max_x:X轴最大值,float:数据保留小数位数,title:行标题
...
//4>显示水平线
    ...
    function changeChartdata(_changecell,_changexvalue,_upcells,_updatecharts){
       var  dataJSONa={
        ...
        DataManager.GetData402(dataJSONa,function(_result){
    ...
    function InitLineData(_groupdata){
        ...
        var dataJSONa={
            data:
            {
                ...
                cvalue:287333,
                citems:[
                    {ipname:"FIC2409",ipvalue:71337,ipitems:_groupdata.group.cells[0].xitems},
                    {ipname:"FIC2503",ipvalue:96333,ipitems:_groupdata.group.cells[2].xitems}]
            }
        }
        ...
        DataManager.GetData402(dataJSONa,function(_result){
            ...
            dataJSONa={
                data:
                {
                    ...
                    cvalue:71337,
                    citems:[
                        {ipname:"FIC2414",ipvalue:287333,ipitems:_groupdata.group.cells[1].xitems},
                        {ipname:"FIC2503",ipvalue:96333,ipitems:_groupdata.group.cells[2].xitems}]
                }
            }
            DataManager.GetData402(dataJSONa,function(_result){
